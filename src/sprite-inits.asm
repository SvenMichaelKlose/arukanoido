...
vaus_init:      is_vaus     0 0 @(+ 128 multiwhite) <gfx_vaus >gfx_vaus    <ctrl_vaus >ctrl_vaus 10 0 0 0
...
bonus_init:     is_bonus    0 0 0          0 >gfx_bonus_l         <ctrl_bonus >ctrl_bonus 9 0 0 0
