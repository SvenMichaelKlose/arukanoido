...
exm_explosion_size =   @(length (fetch-file "obj/explosion.4.raw"))
exm_explosion:         @(fetch-file "obj/explosion.4.rle")
exm_extension_size =   @(length (fetch-file "obj/extension.4.raw"))
exm_extension:         @(fetch-file "obj/extension.4.rle")
...
exm_lost_ball_size =   @(length (fetch-file "obj/lost-ball.4.raw"))
exm_lost_ball:         @(fetch-file "obj/lost-ball.4.exm")
;exm_reflection_doh_size =   @(length (fetch-file "obj/reflection-doh.2.raw"))
;exm_reflection_doh:         @(fetch-file "obj/reflection-doh.2.exm")
exm_reflection_high_size =   @(length (fetch-file "obj/reflection-high.4.raw"))
exm_reflection_high:         @(fetch-file "obj/reflection-high.4.rle")
