...
exm_round_intro_size =   @(length (fetch-file "obj/round-intro.4.raw"))
exm_round_intro:         @(fetch-file "obj/round-intro.4.exm")
exm_round_start_size =   @(length (fetch-file "obj/round-start.4.raw"))
exm_round_start:         @(fetch-file "obj/round-start.4.exm")
exm_reflection_med_size =   @(half (length (fetch-file "obj/reflection-med.1.raw")))
